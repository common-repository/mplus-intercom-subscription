...
if ( ! empty( $honeypot_spam_protect ) && 1 == $honeypot_spam_protect ) {
	$fields [] = apply_filters( 'mplus_intercom_subscription_honeypot_field', [
		'type'     => 'text',
		'label'    => '',
		'name'     => 'honeypot',
		'class'    => 'hide-robot',
...
<div class="mplus-intercom-subscription-wrap">
	...
	<?php
		$company_form = new Mplus_Intercom_Subscription_Form();
		echo $company_form->render_form( $fields );
	?>
	</div>
</div>
